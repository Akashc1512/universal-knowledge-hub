...
class TestEndToEndWorkflow(unittest.TestCase):
    ...
    def test_multi_agent_integration(self):
        ...
        retrieval_result = asyncio.run(retrieval_agent.process_task(retrieval_task, retrieval_context))
        ...
        factcheck_result = asyncio.run(factcheck_agent.process_task(factcheck_task, retrieval_context))
        ...
        synthesis_result = asyncio.run(synthesis_agent.process_task(synthesis_task, retrieval_context))
...
class TestErrorHandlingIntegration(unittest.TestCase):
    ...
    def test_agent_failure_handling(self):
        ...
        # Mock agent failure
        with patch.object(self.orchestrator.agents[AgentType.RETRIEVAL], 'process_task') as mock_process:
