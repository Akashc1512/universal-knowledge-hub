...
class TestLoadTesting:
    ...
    def test_sustained_load(self, client):
        ...
        assert avg_response_time < 5.0, f"Sustained load avg response time too high: {avg_response_time:.2f}s"
    ...
    def test_memory_leak_detection(self, client):
        ...
        for i in range(1000):
            ...
            if i % 100 == 0:
                ...
                assert memory_increase < 200 * 1024 * 1024, f"Memory leak detected: {memory_increase / 1024 / 1024:.1f}MB"
        
        final_memory = process.memory_info().rss
        total_memory_increase = final_memory - initial_memory
        
        # Final memory check
        assert total_memory_increase < 100 * 1024 * 1024, f"Excessive memory usage: {total_memory_increase / 1024 / 1024:.1f}MB"
    ...
    def test_extreme_concurrency(self, client):
        ...
        def make_request():
            return client.post("/query", json={
                "query": "Extreme concurrency test",
                "max_tokens": 100
            })
