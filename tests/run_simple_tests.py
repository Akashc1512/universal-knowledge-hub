...
Runs basic tests to ensure core functionality works after package reorganization.
"""
...
from agents.base_agent import BaseAgent, AgentType, AgentMessage, AgentResult
from agents.base_agent import TestAgent  # Import TestAgent directly
