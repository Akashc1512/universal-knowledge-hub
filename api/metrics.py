...
# System metrics
SYSTEM_MEMORY = Gauge(
    'ukp_system_memory_bytes',
    'System memory usage in bytes',
    registry=registry
)

SYSTEM_CPU = Gauge(
    'ukp_system_cpu_percent',
    'System CPU usage percentage',
    registry=registry
)

ACTIVE_CONNECTIONS = Gauge(
    'ukp_active_connections',
    ...
    def get_metrics_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'cache': {
                ...
                'hit_rate': CACHE_HITS._value.sum() / max(CACHE_HITS._value.sum() + CACHE_MISSES._value.sum(), 1)
            },
            'security': {
